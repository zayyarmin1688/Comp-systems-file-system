...
#define nth_bit_mask(n) (1 << (n)) // help create a mask for the nth but
#define byte_index(n) ((n) / 8)    // byte index for the nth bit
#define bit_index(n) ((n) % 8)     // find the bit index within its byte
